...
//		pan.setBounds(10, 60, 1200, 900);
//		try
//		{
//			URL url=new URL("https://t1.daumcdn.net/movie/f33cd55abf694a01dcd79f37eca9877da3dd9367");
////			pan.setIcon(new ImageIcon(getImage(new ImageIcon(url),200,350)));
//						}catch(Exception ex){}
//			add(pan);
//			setSize(1300, 1000);
//			setVisible(true);
...
//			Elements image=doc.select("div class_info_movie span.thumb_movie img.img_g");
//			for(int i=0;i<20;i++)
//			{
...
public class MovieMain extends JFrame{
    ...
    MovieMain() {
		...
		try
		{
			URL url=new URL("https://t1.daumcdn.net/movie/3651b17dc201e5b4ea6409b364f1e950a14b96a3"); // 사진 주소
